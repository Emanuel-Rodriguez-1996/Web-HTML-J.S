...
function inicio() {
    ...
    document.querySelector("#btnSeleccionarPerfil").addEventListener("click", loginUsuario);
...
function mostrarUsuarioLogueado() {
    ...
    document.querySelector("#seccionReasignar").style.display = "none"
    document.querySelector("#seccionInfoEstadisitca").style.display = "none"
    document.querySelector("#nombreUsuarioLogeado").innerHTML = "<br>" + "<br>"+ "Bienvenido " + usuarioLogueado.nombre + "<br>" + "<br>"+
    " <div class= mt-2 d-flex justify-content-center> <p class= msjFun text-center> Seleccione la funcionalidad requerida en el menu </p> </div>"
}
...
function CargarRegistroCenso() {
    ...
    document.querySelector("#btnRegistrarCenso").style.display = "block"
...
function buscarCensado() {
    ...
    if (ci === null) {
        ...
        <h2 id="titBuscador" class="text-center" style="padding: 2%;">Información sobre la cedula: ${cedulaBuscar}</h2>
        <div id="resultBuscador" class="card">
...
function buscarCiInvitado() {
    ...
    if (ci === null) {
        ...
        for (let i = 0; i < sistema.censados.length; i++) {
            ...
            document.querySelector("#btnMostrarEstadistica").style.display = "block"
        }
    }
}
...
function seccionRegistrarInvi() {
    ...
    document.querySelector("#seccionInvitados").style.display = "none"
    document.querySelector("#btnGuardarInvitado").style.display = "block"
}   
...
function mostrarTablaConteoInvitados(conteo) {
    ...
    // Encabezado de la tabla
    tabla += '<tr><th class="text-bg-dark";>Departamento</th><th class="text-bg-dark";>Estudian</th><th class="text-bg-dark";>No trabajan</th><th class="text-bg-dark";>Dependientes o Independientes</th><th class="text-bg-dark";>Porcentaje del total de censados</th></tr>';
